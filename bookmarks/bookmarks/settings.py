...
SECRET_KEY = 'w$(1=_7p&6yo6rk$%0p&4&+6akpa5e$n1bgk&2zg$=95(2-q64'
...
MIDDLEWARE = [
    ...
    'django.contrib.sessions.middleware.SessionMiddleware',   # messages framework middleware
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [                                     # context_processors list
                'django.template.context_processors.debug',
                'django.template.context_processors.request',
                'django.contrib.auth.context_processors.auth',
                'django.contrib.messages.context_processors.messages',  # adds a messages variable to the request context
            ],
        },
    },
]
